    ...
    <body footer="nlfooter" footer-height="20pt" padding="0.5in 0.5in 0.5in 0.5in" size="Letter">
        ...
        <table>
            <tr>
                <td align="center" border="1" style="font-size: 16px; font-weight: bold;"><b>Acta de Entrega -
                        Recepci&oacute;n de Materiales</b></td>
                <td>&nbsp;</td>
            </tr>
        </table>
        ...
        <table border="1" style="margin-top: 10px; width: 400px;">
            <tr>
                ...
                <td colspan="10" align="left" class="border" style="font-size: 10px;">${ordenventa.trandate}</td>
            </tr>
            <tr>
                <td align="left" colspan="3" style="font-weight: bold">ID. Cliente</td>
                <td align="left" class="border">:</td>
                <td colspan="10" align="left" class="border" style="font-size: 10px;">${ordenventa.entity}</td>
            </tr>
            <tr>
                <td align="left" colspan="3" style="font-weight: bold">Subsidiaria</td>
                <td align="left" class="border">:</td>
                <td colspan="10" align="left" class="border" style="font-size: 10px;">${ordenventa.subsidiary}</td>
            </tr>

            <tr>
                <td align="left" colspan="3" style="font-weight: bold">Teléfono</td>
                <td align="left" class="border">:</td>
                <td colspan="10" align="left" class="border" style="font-size: 10px;">${ordenventa.entity.phone}</td>
            </tr>
            <tr>
