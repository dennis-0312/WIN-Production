...
define(['N/search', 'N/record', 'N/email', 'N/runtime', 'N/log', 'N/file', 'N/task', 'N/format', "N/config"],
    (search, record, email, runtime, log, file, task, format, config) => {
        ...
        const execute = (context) => {
            ...
            var searchId = 'customsearch_pe_detracciones_x_pagar_nc' //! IMorales 20230901 - incluye NC, orientado a items
            ...
            try {
                ...
                log.debug({
                    title: "searchLoadColumns",
                    details: searchLoad.columns
                });
                ...
                var customRecord = record.create({
                    ...
                    type: 'customrecord_pe_generation_logs',//IMorales 20230727
                    isDynamic: true
                });
                if (featureSubsidiary || featureSubsidiary == 'T') {
                    var nameData = {
