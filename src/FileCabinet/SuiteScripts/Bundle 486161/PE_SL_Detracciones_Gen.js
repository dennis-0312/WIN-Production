            ...
            try {
                if (context.request.method === 'GET') {
                    ...
                    if (filterPage == '3' || filterPage == 3) {
                        ...
                        var mySearch = search.load({ id: 'customsearch_pe_gene_logs_detraction' }); //! Saved Search: 2521 - PE Generation Logs Detraction
                        ...
                        if (featureSubsidiary || featureSubsidiary == 'T') {
                            ...
                            var myFilter = search.createFilter({ name: 'country', operator: search.Operator.IS, values: 'PE' });
                            var mySearchSubs = search.create({ type: search.Type.SUBSIDIARY, columns: ['internalId', 'name'], filters: myFilter });
                        ...
                        var mySearch = search.load({ id: 'customsearch_pe_accounts_bankings' }); //! Saved Search: 2522 - PE Accounts Bankings
                        ...
                        if (filterPage == '2') {
                            ...
                            var searchLoad = search.load({
                                ...
                                id: 'customsearch_pe_detracciones_x_pagar_nc' //! IMorales, incluye NC, orientado a items
                            });
